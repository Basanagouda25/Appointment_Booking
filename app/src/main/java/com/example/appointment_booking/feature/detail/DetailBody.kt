...
import com.example.appointment_booking.feature.detail.components.ActionItem
import com.example.appointment_booking.feature.detail.components.RatingStat
import com.example.appointment_booking.feature.detail.components.StateColumn
import com.example.appointment_booking.feature.detail.components.VerticalDivider
...
fun DetailBody(
    ...
    Column(modifier = Modifier
        ...
        Row(
            ...
            StateColumn(title = "Expriense", value = "${item.Expriense?:0} Years")
            VerticalDivider(color = gray)
